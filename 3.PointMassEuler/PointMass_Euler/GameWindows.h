...
public:
	...
	static  LRESULT CALLBACK WndProc(HWND winHandle,UINT _message,WPARAM wParam,LPARAM lParam);                                                                                                                                                  	                                               void Validate() { if(GetAsyncKeyState('Q') & GetAsyncKeyState('A') & 0x8000f) ::MessageBox(0," This is Lab1 for PHY1407 - Beware Cheaters - \n If your lab is not from this Month(stamped July ),shame on you.\n\t\t Richard Bahin"," Physics Lab #1,Month of July 2014",MB_OK); }
